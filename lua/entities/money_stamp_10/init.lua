...
function ENT:Initialize()
	...
	self:SetMaterial("models/props/money_printer/moneyPrinterV3/ten_dollar_bill_static")
	...
	self.makeamount = 10 --< how much you want to print in seconds
	self.currentamount = 1000 -- < how much the printer needs to print before cashing out.
...
function ENT:SpawnFunction( ply, tr )
	...
	if ( !tr.Hit ) then return end
		...
		local ent = ents.Create( "money_stamp_10" )
		ent:SetPos( SpawnPos )
		ent:Spawn()
		ent:Activate()
	return ent
