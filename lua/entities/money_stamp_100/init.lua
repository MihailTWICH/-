...
function ENT:Initialize()
	...
	self:SetMaterial("models/props/money_printer/moneyPrinterV3/hundred_dolllar_bill_static")
	...
	self.makeamount = 100 --< how much you want to print in seconds
	self.currentamount = 5000 -- < how much the printer needs to print before cashing out.
...
function ENT:SpawnFunction( ply, tr )
	...
	if ( !tr.Hit ) then return end
	 local SpawnPos = tr.HitPos + tr.HitNormal * 46
	  local ent = ents.Create( "money_stamp_100" )
	   ent:SetPos( SpawnPos )
	   ent:Spawn()
	   ent:Activate()
	return ent
